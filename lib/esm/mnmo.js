...
class Combobox extends Input {
    ...
    ensureHiddenInput() {
        ...
        let hidden = this.trigger.nextElementSibling;
    ...
    applyFilter(query) {
        ...
        for (const option of allOptions) {
            const shouldShow = (_e = (_c = (_b = (_a = this.config) === null || _a === void 0 ? void 0 : _a.filter) === null || _b === void 0 ? void 0 : _b.call(_a, option, query)) !== null && _c !== void 0 ? _c : (_d = option.textContent) === null || _d === void 0 ? void 0 : _d.toLowerCase().includes(normalized)) !== null && _e !== void 0 ? _e : false;
...
export { Checkbox, CheckboxGroup, Combobox, FileInput, Form, Input, Listbox, Popover, RadioGroup, Select, Tabs, Textbox, selectElement, uid };

...
class Form {
    ...
    destroy() {
        var _a;
        (_a = this.eventHandlers) === null || _a === void 0 ? void 0 : _a.forEach(([event, handler]) => {
    ...
    addEventListener(event, handler, capture = false) {
        ...
        (_a = this.eventHandlers) === null || _a === void 0 ? void 0 : _a.push([event, fn]);
        ...
        return __awaiter(this, void 0, void 0, function* () {
            if (this.config && this.config[key]) {
                if (typeof this.config[key] === "function") {
                    yield this.config[key](this, event);
                }
            }
        });
    }
...
export { Checkbox, CheckboxGroup, FileInput, Form, Input, Listbox, RadioGroup, Select, Tabs, Textbox, selectElement, uid };

...
class Input {
    ...
    get dynamicValidity() {
        ...
        return (
            ...
            validityFn(
                this.value,
                (_b = this.form) === null || _b === void 0 ? void 0 : _b.values
            )
        );
    }
...
const maskValue = (value, mask, event) => {
    ...
    if (
        (_a = event === null || event === void 0 ? void 0 : event.inputType) ===
            null || _a === void 0
            ? void 0
            : _a.includes("delete")
    ) {
...
class Textbox extends Input {
    ...
    get value() {
        var _a;
        if (
            (_a = this.config) === null || _a === void 0 ? void 0 : _a.valueAs
        ) {
...
class Listbox {
    ...
    set selected(selectedOption) {
        ...
        if (
            (_a = this.config) === null || _a === void 0 ? void 0 : _a.onSelect
        ) {

    ...
    ***************************************************************************** */
    ...
    const selectElement = (selector, constructor, parent = document.body) => {
        const isInstanceOfConstructor = (element) => {
            ...
            return (
                constructor.filter((item) => element instanceof item).length > 0
            );
        };
    ...
    class Form {
        ...
        handleInput() {
            ...
            (_a = this.inputs) === null || _a === void 0
                ? void 0
                : _a.forEach((input) => input.validate());
            this.emit("onInput");
        }
        handleChange() {
            if (!this.isDirty) this.isDirty = true;
            ...
            for (const input of inputs.flat()) {
                ...
                this.inputs =
                    (_b =
                        (_a = this.inputs) === null || _a === void 0
                            ? void 0
                            : _a.concat(input)) !== null && _b !== void 0
                        ? _b
                        : [input];
            }
        }
        getInput(name) {
            var _a;
            return (_a = this.inputs) === null || _a === void 0
                ? void 0
                : _a.filter((input) => input.name === name)[0];
        }
        get errors() {
            let errors = {};
    ...
    class Input {
        ...
        getDefaultValidationMessage() {
            var _a, _b;
            return (_b =
                (_a = this.defaultValidationMessage) !== null && _a !== void 0
                    ? _a
        ...
        getCustomValidationMessage(key) {
            const customMessage = this.elements[0].getAttribute(
                `${key}-message`
            );
        ...
        get errorConstraintMap() {
            const errorConstraintMap = [["badInput"], ["typeMismatch"]];
    ...
    const restoreCursorPosition = (value, mask, event, callback) => {
        ...
        let beforeLeftOfCursorBeforeFormatting = unformattedValue.slice(
            0,
            cursorPosition !== null && cursorPosition !== void 0
                ? cursorPosition
                : undefined
        );
        ...
        if (
            (_a =
                event === null || event === void 0
                    ? void 0
                    : event.inputType) === null || _a === void 0
                ? void 0
                : _a.includes("delete")
        ) {
        ...
        constructor(element, config) {
            ...
            this.mask =
                (_b =
                    (_a = this.config) === null || _a === void 0
                        ? void 0
                        : _a.mask) !== null && _b !== void 0
                    ? _b
                    : this.element.getAttribute("mask");
    ...
    class Tabs {
        ...
        selectByTab(selectedTab) {
            ...
            this.selectedTabPanel =
                this.tabPanels[this.tabs.indexOf(selectedTab)];
            this.handleSelection();
        }
        handleSelection() {
            var _a;
    ...
    class Listbox {
        ...
        get value() {
            ...
            return (_a = this.selected.getAttribute("value")) !== null &&
                _a !== void 0
                ? _a
        ...
        checkKeyDown(event) {
            ...
            if (this.selected) {
                ...
                next =
                    current == this.options.length - 1 ? current : current + 1;
    ...
    var index = Object.assign(Object.assign({}, components), { util });
    window.mnmo = Object.assign({ util }, components);
